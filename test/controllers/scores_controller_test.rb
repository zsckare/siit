...
class ScoresControllerTest < ActionController::TestCase
  ...
  test "should create score" do
    assert_difference('Score.count') do
      post :create, score: { nocontrol: @score.nocontrol, score: @score.score, subject_id: @score.subject_id }
    end
  ...
  test "should update score" do
    patch :update, id: @score, score: { nocontrol: @score.nocontrol, score: @score.score, subject_id: @score.subject_id }
    assert_redirected_to score_path(assigns(:score))
  end
